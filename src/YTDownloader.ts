...
export default class YTDownloader {
    ...
    private static async getVideoInfo(url: string, format: FilterFormat): Promise<VideoInfo | ErrorMessage> {
    ...
    private static execDownload(videoInfo: VideoInfo, downloadOptions: DownloadOptions): Promise<void> {
